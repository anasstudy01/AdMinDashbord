              ...
              <Form className="p-6 md:p-8">
                <div className="flex flex-col gap-6">
                  ...
                  <div className="grid gap-3">
                    ...
                    <Field as={Input} id="name" name="name" placeholder="Your name" required />
                    <ErrorMessage name="name" component="div" className="text-xs text-red-500" />
                  </div>
                  <div className="grid gap-3">
                    <Label htmlFor="email">Email</Label>
                    <Field as={Input} id="email" name="email" type="email" placeholder="m@example.com" required />
                    <ErrorMessage name="email" component="div" className="text-xs text-red-500" />
                  </div>
                  <div className="grid gap-3">
                    <Label htmlFor="password">Password</Label>
                    <Field as={Input} id="password" name="password" type="password" required />
                    <ErrorMessage name="password" component="div" className="text-xs text-red-500" />
                  </div>
                  <div className="grid gap-3">
                    <Label htmlFor="confirmPassword">Confirm Password</Label>
                    <Field as={Input} id="confirmPassword" name="confirmPassword" type="password" required />
